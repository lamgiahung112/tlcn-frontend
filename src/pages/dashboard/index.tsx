...
function Dashboard() {
	const tayGaItems: VehicleExplorerItem[] = [
		{
			name: "LEXI",
			goToDetailLink: "/xe/LEXI/a",
			image: lexiPng,
			price: "54.500.000 VND",
		},
		{
			name: "GRANDE",
			goToDetailLink: "/xe/GRANDE/a",
			image: grandePng,
			price: "46.047.000 VND",
		},
		{
			name: "FREEGO",
			goToDetailLink: "/xe/FREEGO/a",
			image: freegoPng,
			price: "30.142.000 VND",
		},
		{
			name: "LATTE",
			goToDetailLink: "/xe/LATTE/a",
			image: lattePng,
			price: "38.095.000 VND",
		},
		{
			name: "JANUS",
			goToDetailLink: "/xe/JANUS/a",
			image: janusPng,
			price: "28.571.000 VND",
		},
		{
			name: "NVX",
			goToDetailLink: "/xe/NVX/a",
			image: nvxPng,
			price: "54.500.000 VND",
		},
	]
	return (
		<div className="flex flex-col w-full gap-y-32">
			<Carousel images={[banner_2, banner_3]} durationUntilNext={5000} />
			<Section title="KHÁM PHÁ SẢN PHẨM">
				<VehicleExplorer title="XE TAY GA" items={tayGaItems} />
			</Section>
			<SectionSpacer />
			<Section>
				<VehicleExplorer title="XE TAY GA" items={tayGaItems} />
