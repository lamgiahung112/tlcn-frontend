...
function Design() {
  return (
    <div className="flex flex-col gap-y-[10vh] pl-[10vw]">
      ...
      <div className="relative">
        <img
          ...
          alt=""
        />
        <span className="absolute top-0 left-0 z-[10] text-white text-opacity-25 text-9xl font-bold">
          LEXI
        </span>
        <img
          ...
          alt=""
        />
        <div className="p-8 max-w-[50%] font-medium text-xl">
          Thiết kế ấn tượng khi kết hợp giữa phong cách thể thao và sự tinh tế
          thời thượng
        </div>
      </div>
