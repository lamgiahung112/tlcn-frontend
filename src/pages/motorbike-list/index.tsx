					...
					<div className="flex flex-wrap gap-x-8 justify-between">
						<div className="flex flex-col w-full md:w-[40%] lg:w-[30%] bg-neutral-200 p-8 hover:bg-neutral-100 cursor-pointer">
							...
							<div className="line-clamp-3 text-neutral-500 text-sm leading-6 w-full text-ellipsis whitespace-normal">
								Xuất phát từ khái niệm "kết hợp phong cách thể thao và sự
								tinh tế thời thượng", LEXI 2024 hoàn toàn mới mang lại sức
								hấp dẫn khó cưỡng với kiểu dáng hiện đại và sang trọng,
								khả năng kết nối điện thoại thông minh tiện lợi, sức mạnh
								khối động cơ 155cc cho công suất và hiệu suất vượt trội so
								với những khối động cơ cùng dung tích.
							</div>
							<img
								alt=""
